 ...
 *
 * @param {RefObject<HTMLElement>} elementRef - A ref to the parent element containing the scroll area.
 ...
 */
export function useScrollState(elementRef: RefObject<HTMLElement>) {
  ...
  useEffect(() => {
    ...
    const scrollArea = elementRef.current;
