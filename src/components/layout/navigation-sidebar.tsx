...
export default function NavigationSideBar() {
    ...
    return (
        <div
            ...
            className={`fixed inset-y-0 left-0 z-[99] hidden lg:flex flex-col justify-start items-center overflow-x-hidden border-r bg-background shadow-md transition-all duration-150 overflow-y-auto pb-10 pt-20 scroll-bar-hidden ${canExpand ? 'w-60' : 'w-16'}`}
