        ...
        >
          {value.map((item, index) => (
            <Badge
              ...
              className={cn(
                "relative flex items-center gap-1 truncate rounded-full px-2 aria-disabled:cursor-not-allowed aria-disabled:opacity-50 data-[active='true']:ring-2 data-[active='true']:ring-muted-foreground"
              )}
              variant={'default'}
            >
              <span className="text-xs">{item}</span>
              <BasicTooltip label={`Remove ${item}`}>
                <button
                  type="button"
          ...
          <Input
            ...
            className={cn(
              'h-7 min-w-fit flex-1 border-none px-1 shadow-none outline-0 placeholder:text-muted-foreground focus-visible:border-0 focus-visible:outline-0 focus-visible:ring-0 focus-visible:ring-offset-0',
